...
class ApiController extends Controller
{
    public function processQuery(Request $request, $model, $action, $method)
    {
        ...
        $queryClassName = '\\Jmondi\\Gut\\Action\\' . $model . '\\' . $queryActionName;
        $requestClassName = '\\Jmondi\\Gut\\Action\\' . $model . '\\Query\\' . $requestActionName;
        $responseClassName = '\\Jmondi\\Gut\\Action\\' . $model . '\\Query\\' . $responseActionName;
    ...
    public function processCommand(Request $request, $model, $action, $method = '')
    {
        ...
        $commandClassName = '\\Jmondi\\Gut\\Action\\' . $model . '\\' . $action;
    ...
    private function getDynamicObject($requestClassName, $query)
    {
        ...
        foreach ($query as $key => $value) {
            $entityDTOClassName = '\\Jmondi\\Gut\\EntityDTO\\' . $key;
